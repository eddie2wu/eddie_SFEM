...
clear
capture log close
* cd C:\Users\53500\OneDrive\academia\Projects\RA-deClippel\Evolution_Cooperation\pronouncement\scripts
...
insheet treatment round G coope0 coope1 coope2 coope3 coope4 coope5 coope6 coope7 coope8 coope9 coope10 coope11 coope12 coope13 coope14 foo using simulationresults.txt, tab
...
gen goodrange=1 if treatment==1 & round<60
replace goodrange=1 if treatment==2 & round<72
replace goodrange=1 if treatment==3 & round<69
replace goodrange=1 if treatment==4 & round<28
replace goodrange=1 if treatment==5 & round<24
replace goodrange=1 if treatment==6 & round<30
...
twoway (line coop round if treatment==4 & round<=60, title(delta=low r=normal) subtitle(Neither SGPE nor RD with GT) legend(off) graphregion(color(white)) xtitle("Repeated Game (log scale)") ytitle("Cooperation") yscale(range(0 1)) ylabel(#11) xscale(log) xlabel(1 5 10 20 40 100 300 1000)) (line g round if treatment==4, lpattern(dash)) (line lowlimit90 round if treatment==4,  lpattern(dot) lcolor(cranberry)) (line upplimit90 round if treatment==4, lpattern(dot) lcolor(cranberry)), saving(graphd75r32,replace)
twoway (line coop round if treatment==5 & round<=30, title(delta=high r=high) subtitle(SGPE & RD) legend(off) graphregion(color(white)) xtitle("Repeated Game (log scale)") ytitle("Cooperation") yscale(range(0 1)) ylabel(#11) xscale(log) xlabel(1 5 10 20 40 100 300 1000)) (line g round if treatment==5, lpattern(dash)) (line lowlimit90 round if treatment==5,  lpattern(dot) lcolor(cranberry)) (line upplimit90 round if treatment==5, lpattern(dot) lcolor(cranberry)), saving(graphd75r40,replace)
twoway (line coop round if treatment==6 & round<=30, title(delta=high r=high) subtitle(SGPE & RD with GT) legend(off) graphregion(color(white)) xtitle("Repeated Game (log scale)") ytitle("Cooperation") yscale(range(0 1)) ylabel(#11) xscale(log) xlabel(1 5 10 20 40 100 300 1000)) (line g round if treatment==6, lpattern(dash)) (line lowlimit90 round if treatment==6,  lpattern(dot) lcolor(cranberry)) (line upplimit90 round if treatment==6, lpattern(dot) lcolor(cranberry)), saving(graphd75r48,replace)
...
twoway (line coope coopingroup if treatment==1,  title(delta=high r=normal) subtitle(SGPE) legend(off) graphregion(color(white)) xtitle("Number of cooperative actions") ytitle("Proportion") yscale(range(0 1)) ylabel(#11) xscale(range(0 14)) xlabel(#15) scale(.7)) (line coope1 coopingroup if treatment==1, lpattern(dash)), saving(graphd5r32,replace) 
twoway (line coope coopingroup if treatment==2,  title(delta=low r=normal) subtitle(Neither SGPE nor RD) legend(off) graphregion(color(white)) xtitle("Number of cooperative actions") ytitle("Proportion") yscale(range(0 1)) ylabel(#11) xscale(range(0 14)) xlabel(#15) scale(.7) xline(10.5)) (line coope1 coopingroup if treatment==2, lpattern(dash)), saving(graphd5r40,replace) 
twoway (line coope coopingroup if treatment==3,  title(delta=high r=normal) subtitle(SGPE with GT) legend(off) graphregion(color(white)) xtitle("Number of cooperative actions") ytitle("Proportion") yscale(range(0 1)) ylabel(#11) xscale(range(0 14)) xlabel(#15) scale(.7) xline(5.5)) (line coope1 coopingroup if treatment==3, lpattern(dash)), saving(graphd5r48,replace) 
twoway (line coope coopingroup if treatment==4,  title(delta=low r=normal) subtitle(Neither SGPE nor RD with GT) legend(off) graphregion(color(white)) xtitle("Number of cooperative actions") ytitle("Proportion") yscale(range(0 1)) ylabel(#11)  xscale(range(0 14)) xlabel(#15) scale(.7) xline(11.5)) (line coope1 coopingroup if treatment==4, lpattern(dash)), saving(graphd75r32,replace) 
twoway (line coope coopingroup if treatment==5,  title(delta=high r=high) subtitle(SGPE & RD) legend(off) graphregion(color(white)) xtitle("Number of cooperative actions") ytitle("Proportion") yscale(range(0 1)) ylabel(#11) xscale(range(0 14)) xlabel(#15) scale(.7) xline(3.5)) (line coope1 coopingroup if treatment==5, lpattern(dash)), saving(graphd75r40,replace)
twoway (line coope coopingroup if treatment==6,  title(delta=high r=high) subtitle(SGPE & RD with GT) legend(off) graphregion(color(white)) xtitle("Number of cooperative actions") ytitle("Proportion") yscale(range(0 1)) ylabel(#11) xscale(range(0 14)) xlabel(#15) scale(.7) xline(2.5)) (line coope1 coopingroup if treatment==6, lpattern(dash)), saving(graphd75r48,replace) 
...
collapse coop, by (treatment round)
sort treatment round
merge treatment round using simulationresultscross
